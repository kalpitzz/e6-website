...
export const Highlight = ({ children, className }: any) => {
  return (
    <motion.span
      initial={{
      ...
      className={cn(
        `pb-1 px-1 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 text-shadow-2 text-white mr-1`,
        className
      )}
    >
      {children}
...
export const HighlightStats = ({ children, className }: any) => {
